...
# def process_pdf():
#     """
#     Will load PDFs, split them, and create/load a Vector Store.      
#     """
#     # Embeddings initialize karein
#     embeddings = HuggingFaceEmbeddings(model_name="all-MiniLM-L6-v2")
#     persist_dir = "./chroma_db"

#     # 🛑 NAYA LOGIC: Agar DB pehle se hai, toh sirf load karo
#     if os.path.exists(persist_dir) and os.listdir(persist_dir):
#         print("🔄 Existing Vector Database load kar rahe hain...")
#         vectorstore = Chroma(persist_directory=persist_dir, embedding_function=embeddings)
#         return vectorstore

#     # --- Niche aapka purana logic same rahega ---
...
#     print("🔄 Creating new Vector Database (ChromaDB)...")
